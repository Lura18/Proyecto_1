...
public class PanelFormularioExamen extends JPanel {
    ...
    public Examen crearExamen(Profesor profesor, LearningPath learningPath) {
        ...
        Examen examen = new Examen(learningPath, descripcion, objetivo, dificultad, duracion, obligatorio, profesor);
        profesor.añadirActividadALearningPath(learningPath, examen);
