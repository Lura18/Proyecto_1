...
public class PanelFormularioEncuesta extends JPanel {
    ...
    public PanelFormularioEncuesta() {
    ...
    public Encuesta crearEncuesta(Profesor profesor, LearningPath learningPath) {
        ...
        Encuesta encuesta = new Encuesta(learningPath, descripcion, objetivo, dificultad, duracion, obligatorio, profesor);
        profesor.añadirActividadALearningPath(learningPath, encuesta);
