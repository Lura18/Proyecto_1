...
public class PanelBienvenidaE extends JPanel {
    private static final long serialVersionUID = 1L;

    private JLabel mensajeBienvenida;

    public PanelBienvenidaE(Usuario usuario) {
        setLayout(new BorderLayout());

        // Crear el mensaje de bienvenida
        mensajeBienvenida = new JLabel("Bienvenido/a estudiante, " + usuario.getNombre() + "!", SwingConstants.CENTER);
