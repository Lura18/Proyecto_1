...
public class PanelLearningPathsProfesor extends JPanel {
    private static final long serialVersionUID = 1L;

    private JTable tablaLearningPaths;
    private DefaultTableModel modeloTabla;

    public PanelLearningPathsProfesor(Profesor profesor) {
        setLayout(new BorderLayout());
        setBackground(Color.WHITE); // Fondo blanco

        // Título del panel
        JLabel titulo = new JLabel("Learning Paths Creados", SwingConstants.CENTER);
    ...
    public void actualizarTabla(Profesor profesor) {
        modeloTabla.setRowCount(0); // Limpiar la tabla antes de agregar los nuevos elementos
        List<LearningPath> learningPathsInscritos = profesor.getLearningPathsCreados();
    ...
    public LearningPath getLearningPathSeleccionado(Profesor profesor) {
