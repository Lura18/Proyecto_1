...
public class PanelBienvenidaProfesor extends JPanel {
    private static final long serialVersionUID = 1L;

    private List<Actividad> actividades;
    private List<LearningPath> paths;
    
    public PanelBienvenidaProfesor(Profesor profesor, List<Actividad> actividades , List<LearningPath> paths) {
        ...
        JLabel mensajeBienvenida = new JLabel("¡Bienvenido, " + profesor.getNombre() + "!");
